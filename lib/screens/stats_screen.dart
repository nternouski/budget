...
class _StatsScreenState extends State<StatsScreen> {
  ...
  Widget getBody() {
    ...
    List expenses = [
      {"icon": Icons.arrow_back, "color": blue, "label": "Income", "cost": "\$6593.75"},
      {"icon": Icons.arrow_forward, "color": red, "label": "Expense", "cost": "\$2645.50"}
    ];
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text("\$2446.90", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 25))
                        ],
                      ),
                    ),
                    Positioned(
                      bottom: 0,
                      child: Container(width: (size.width - 20), height: 150, child: LineChart(mainData())),
                    )
                  ],
                ),
              ),
                    ...
                    child: Column(
                      ...
                      children: [
                        Container(
                          width: 40,
                          height: 40,
                          decoration: BoxDecoration(shape: BoxShape.circle, color: expenses[index]['color']),
                          child: Center(
                              child: Icon(
                            expenses[index]['icon'],
                            color: white,
